...
## 注意 注意注意
    ...
    我自己的docker  monefyly1/nvjdc 认清楚
...
国内
```
git clone https://ghproxy.com/https://github.com/monefyly1/nvjdcdocker.git /root/nolanjdc
```
国外
```
git clone https://github.com/monefyly1/nvjdcdocker.git /root/nolanjdc
```


2 拉取基础镜像以后不需要拉取镜像了 如果需要拉取我会通知
```
sudo docker pull monefyly1/nvjdc:latest
```
...
-it --privileged=true  monefyly1/nvjdc:latest
```
...
安装地址 https://github.com/monefyly1/nvjdcdocker/blob/main/Arm%E5%AE%89%E8%A3%85%E8%AF%B4%E6%98%8E.md
